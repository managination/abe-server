...
package com.example.abe.security;
...
//    }
    ...
    private static class Delegate extends MessageDigest
        ...
        private static final class CloneableDelegate extends MessageDigest.Delegate
        ...
        static MessageDigest.Delegate of(MessageDigestSpi digestSpi, String algo,
                                         Provider p) {
            ...
            return (isCloneable? new CloneableDelegate(digestSpi, algo, p) :
                    new MessageDigest.Delegate(digestSpi, algo, p));
        }
