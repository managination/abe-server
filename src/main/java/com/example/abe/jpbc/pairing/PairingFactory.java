package com.example.abe.jpbc.pairing;

import com.example.abe.jpbc.Pairing;
import com.example.abe.jpbc.PairingParameters;
import com.example.abe.jpbc.pairing.a.TypeAPairing;
import com.example.abe.jpbc.pairing.a1.TypeA1Pairing;
import com.example.abe.jpbc.pairing.d.TypeDPairing;
import com.example.abe.jpbc.pairing.e.TypeEPairing;
import com.example.abe.jpbc.pairing.f.TypeFPairing;
import com.example.abe.jpbc.pairing.g.TypeGPairing;
import com.example.abe.jpbc.pairing.immutable.ImmutableParing;
...
public class PairingFactory {
    ...
    public static class CTL13MultilinearPairingCreator implements PairingCreator {
        ...
        public CTL13MultilinearPairingCreator() {
            try {
                Class pbcPairingFactoryClass = Class.forName("com.example.abe.jpbc.mm.clt13.pairing.CTL13PairingFactory");
    ...
    public class EllipticCurvesPairingCreator implements PairingCreator {
        ...
        public EllipticCurvesPairingCreator() {
            ...
            try {
                Class pbcPairingFactoryClass = Class.forName("com.example.abe.jpbc.pbc.PBCPairingFactory");
